package com.jya.todolist.controller;
...
import com.jya.todolist.dto.Result;
import com.jya.todolist.dto.Todo;
import com.jya.todolist.service.TodoService;
...
public class TodoController {
	...
	@PostMapping("/todo")
	public ResponseEntity<Result> addTodo(@RequestBody Todo todo) { 
		System.out.println(todo);
		boolean flag = todoService.addTodo(todo);
		if (flag) {
			return new ResponseEntity<Result>(new Result(true, "새로운 todo가 등록되었습니다. : " + todo.getNo()), HttpStatus.CREATED);
		} 
